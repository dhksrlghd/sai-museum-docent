...
대부분의 RAG 데모가 "검색 + LLM 응답" 한 화면짜리에서 끝나는 반면, K-Curator는 데이터를
...
모든 작품 텍스트·이미지는
[국립중앙박물관 큐레이터 추천 소장품](https://www.museum.go.kr/MUSEUM/contents/M0501000000.do)
및 [상설전시·특별전 페이지](https://www.museum.go.kr/MUSEUM/contents/M0201010000.do)에서
공공누리 3유형(출처표시+변경금지) 라이선스로 활용했습니다.

K-Curator 코드 자체는 포트폴리오 데모 목적이며, 박물관/큐레이터의 공식 도슨트가 아닙니다.
